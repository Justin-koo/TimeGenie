...
class InstructorForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.user:
            ...
            self.fields['instructor_name'].initial = self.user.instructor_profile.instructor_name
    ...
    def save(self, commit=True):
        ...
        instructor_profile = super(InstructorForm, self).save(commit=False)
        instructor_profile.user = user
        if commit:
